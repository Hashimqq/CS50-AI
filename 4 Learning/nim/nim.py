...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        max_q_value = max(self.get_q_value(state_tuple, action) for action in available_actions)
        return max_q_value
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if epsilon and random.random() < self.epsilon:
            ...
            return max(available_actions, key=lambda action: self.get_q_value(state_tuple, action))

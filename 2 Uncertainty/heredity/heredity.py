...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] is None and people[person]["father"] is None:
            gene_probbility = PROBS["gene"][genes]
            ...
            if person in one_gene:
                gene_probbility = (parents["mother"] * (1 - parents["father"])) + (
                        parents["father"] * (1 - parents["mother"]))
            elif person in two_genes:
                gene_probbility = parents["mother"] * parents["father"]
            else:
                gene_probbility = (1 - parents["father"]) * (1 - parents["mother"])

        if person in have_trait:
            gen_trait_prob = PROBS["trait"][genes][True]
        else:
            gen_trait_prob = PROBS["trait"][genes][False]

        p = p * gen_trait_prob * gene_probbility
